...
public abstract class ErrorListException extends Exception {
     ...
     *
     * @param errorListDescriptor contains the descriptions for the list of error
     * @param messageSummary      message that notifies the user about the error check
     * @param errors              List of errors in type string
     */
